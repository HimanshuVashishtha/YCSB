...
/**
 * A hacked version of the HBase client for YCSB framework. It works with multiple column families.
 * Will be useful in case where we want to test the performance with >1 CFs, like in the case of 
 * CF level memstore flushes.
 */
public class HBaseClientForMultiCFs extends com.yahoo.ycsb.DB
{
    ...
    public List<String> columnFamilies = new ArrayList<String>();
    public String columnFamiliesStr;
    
    // for now, lets make three column families. a, b, c
    int count_a, count_b, count_c = 0;
    ...
    public void init() throws DBException
    {
        ...
        // I expect this property to be a comma separated list of CFs.
        columnFamiliesStr = getProperties().getProperty("columnfamilyList");
        if (columnFamiliesStr == null)
        {
            System.err.println("Error, must specify a columnfamily for HBase table");
            throw new DBException("No columnfamily specified");
        }
        for (String cf : columnFamiliesStr.split(","))
            ...
            Thread t=new Thread()
            {
                public void run()
                {
                    try
                    {
                        ...
                        HBaseClientForMultiCFs cli=new HBaseClientForMultiCFs();
